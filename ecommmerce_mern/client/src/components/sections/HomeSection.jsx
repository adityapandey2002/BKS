...
const HomeSection = () => {
  ...
  const { slideshow, siteName, tagline, loading: assetsLoading } = useSiteAssets(); // Get slideshow from database
  ...
  // Filter active slides from database
...
{/* Hero Slideshow Section - FIXED for 16:9 images */}
{!assetsLoading && activeSlides.length > 0 ? (
  <div className="relative w-full bg-gray-900">
    ...
    <div className="relative w-full" style={{ paddingBottom: '56.25%' }}> {/* 16:9 = 56.25% */}
      ...
      {activeSlides.map((slide, index) => (
        ...
        >
          {/* Slide Image - FIXED: Using object-contain instead of object-cover */}
          {slide.imageUrl && (
            <img
              src={slide.imageUrl}
              alt={slide.title}
              className="w-full h-full object-contain bg-gray-900" // ← Changed from object-cover to object-contain
            />
          )}
  ...
  // Default Hero (no slideshow in database)
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        {isLoading ? (
          <div className="text-center py-12">
            <div className="animate-spin rounded-full h-12 w-12 md:h-16 md:w-16 border-b-4 border-orange-600 mx-auto mb-4"></div>
            <p className="text-gray-600 text-sm md:text-base">Loading featured products...</p>
          </div>
